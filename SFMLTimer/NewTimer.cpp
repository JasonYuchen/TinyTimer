...
int main()
{
	...
	vector<pair<wstring, tuple<unsigned int, float, float, float, sf::Color>>> texts = {    // tuple<fontsize, posX, posY, rot, color>
		{ L"小时",	{ 55,150, 20,  0,sf::Color::White } },
		{ L"分钟",	{ 55,150, 80,  0,sf::Color::White } },
		{ L"秒",		{ 55, 80,140,  0,sf::Color::White } },
		{ L"毫秒",	{ 20,100,200,  0,sf::Color::White } },
		{ L"摸",		{ 55,  0,  0,  0,sf::Color::White } },
		{ L"鱼",		{ 55,  0, 50,  0,sf::Color::White } },
